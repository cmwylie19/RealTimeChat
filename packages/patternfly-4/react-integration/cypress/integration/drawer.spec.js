describe('Drawer Demo Test', function () {
    it('Navigate to the drawer demo', function () {
        cy.visit('http://localhost:3000/');
        cy.get('#drawer-demo-nav-item-link').click();
        cy.url().should('eq', 'http://localhost:3000/drawer-demo-nav-link');
    });
    it('Verify text in content', function () {
    ...
    it('Verify drawer expands and collapses', function () {
