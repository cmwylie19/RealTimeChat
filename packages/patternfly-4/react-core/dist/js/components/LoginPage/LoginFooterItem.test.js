...
var _LoginFooterItem = require("./LoginFooterItem");
...
test('renders with PatternFly Core styles', function () {
  var view = (0, _enzyme.shallow)(React.createElement(_LoginFooterItem.LoginFooterItem, {
    target: "_self",
    href: "#"
  }));
...
test('LoginFooterItem  with custom node', function () {
  ...
  var view = (0, _enzyme.shallow)(React.createElement(_LoginFooterItem.LoginFooterItem, null, React.createElement(CustomNode, null)));
  expect(view).toMatchSnapshot();
});
