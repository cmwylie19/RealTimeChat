(function (global, factory) {
  ...
  const DataToolbarItem = exports.DataToolbarItem = _ref => {
    let {
      ...
      children
        ...
        props = _objectWithoutProperties(_ref, ["className", "variant", "breakpointMods", "spacers", "id", "children"]);

    const labelVariant = variant === 'label';
    return React.createElement("div", _extends({
      className: (0, _reactStyles.css)(_dataToolbar2.default.dataToolbarItem, variant && (0, _reactStyles.getModifier)(_dataToolbar2.default, variant), (0, _util.formatBreakpointMods)(breakpointMods, _dataToolbar2.default), (0, _DataToolbarUtils.formatSpacers)(spacers), className)
    }, labelVariant && {
      'aria-hidden': true
    }, {
      id: id
  ...
  DataToolbarItem.propTypes = {
    ...
    variant: _propTypes2.default.oneOfType([_propTypes2.default.any, _propTypes2.default.oneOf(['separator']), _propTypes2.default.oneOf(['bulk-select']), _propTypes2.default.oneOf(['overflow-menu']), _propTypes2.default.oneOf(['pagination']), _propTypes2.default.oneOf(['search-filter']), _propTypes2.default.oneOf(['label'])]),
