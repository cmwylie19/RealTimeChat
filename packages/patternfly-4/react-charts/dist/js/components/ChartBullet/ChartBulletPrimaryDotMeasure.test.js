...
Object.values([true, false]).forEach(function (isRead) {
  test('ChartBulletPrimaryDotMeasure', function () {
    var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletPrimaryDotMeasure.ChartBulletPrimaryDotMeasure, null));
    expect(view).toMatchSnapshot();
  });
});
test('renders component data', function () {
  var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletPrimaryDotMeasure.ChartBulletPrimaryDotMeasure, {
    data: [{
      y: 50
    }, {
      y: 85
