...
var ChipGroupDefaultIsOpenDemo = /** @class */ (function (_super) {
    __extends(ChipGroupDefaultIsOpenDemo, _super);
    function ChipGroupDefaultIsOpenDemo(props) {
    ...
    ChipGroupDefaultIsOpenDemo.prototype.componentDidMount = function () {
        window.scrollTo(0, 0);
    };
    ChipGroupDefaultIsOpenDemo.prototype.render = function () {
        var _this = this;
        var badgeChipArray = this.state.badgeChipArray;
        return (<react_core_1.ChipGroup defaultIsOpen>
    ...
    return ChipGroupDefaultIsOpenDemo;
}(react_1.Component));
exports.ChipGroupDefaultIsOpenDemo = ChipGroupDefaultIsOpenDemo;
