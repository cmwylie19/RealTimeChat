describe('Select Test', function () {
    ...
    it('Verify Typeahead Select', function () {
    ...
    it('Verify Creatable Typeahead Select', function () {
    ...
    it('Verify Typeahead Multi Select', function () {
    ...
    it('Verify Custom Typeahead Multi Select', function () {
    ...
    it('Verify Custom Typeahead Plain Multi Select', function () {
