...
var SwitchDemo = /** @class */ (function (_super) {
    ...
    SwitchDemo.prototype.render = function () {
        ...
        <react_core_1.Switch id="simple-switch" label={isChecked ? 'Message when on' : 'Message when off'} onChange={this.handleChange} aria-label="Switch" isChecked={isChecked}/>
        <br />
