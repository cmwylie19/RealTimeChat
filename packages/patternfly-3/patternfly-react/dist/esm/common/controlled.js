  ...
  return function (WrappedComponent) {
    var ControlledComponent = function (_React$Component) {
      ...
      function ControlledComponent() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = ControlledComponent.__proto__ || Object.getPrototypeOf(ControlledComponent)).call.apply(_ref2, [this].concat(args))), _this), _this.state = _extends({}, nullValues(types), defaults), _this.setControlledState = function (updater) {
          ...
          if (persist && persist.length > 0) {
            var toPersist = selectKeys(_this.state, persist);
      ...
      _createClass(ControlledComponent, [{
        ...
        value: function render() {
          ...
          var controlledStateProps = filterKeys(this.props, function (key) {
            return types.hasOwnProperty(key) && _this2.props[key] !== null;
          });
          var otherProps = filterKeys(this.props, function (key) {
