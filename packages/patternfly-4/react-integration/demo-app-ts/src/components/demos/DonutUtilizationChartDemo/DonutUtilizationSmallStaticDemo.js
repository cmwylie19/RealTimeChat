...
var DonutUtilizationSmallStaticDemo = /** @class */ (function (_super) {
    __extends(DonutUtilizationSmallStaticDemo, _super);
    function DonutUtilizationSmallStaticDemo() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DonutUtilizationSmallStaticDemo.prototype.componentDidMount = function () {
        window.scrollTo(0, 0);
    };
    DonutUtilizationSmallStaticDemo.prototype.render = function () {
        return (<div>
    ...
    return DonutUtilizationSmallStaticDemo;
}(react_1["default"].Component));
exports.DonutUtilizationSmallStaticDemo = DonutUtilizationSmallStaticDemo;
