...
Object.values([true, false]).forEach(function (isRead) {
  test('ChartBulletComparativeZeroMeasure', function () {
    var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletComparativeWarningMeasure.ChartBulletComparativeWarningMeasure, null));
    expect(view).toMatchSnapshot();
  });
});
test('renders component data', function () {
  var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletComparativeWarningMeasure.ChartBulletComparativeWarningMeasure, {
    data: [{
      y: 100
    }],
    domain: {
