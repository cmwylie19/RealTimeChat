...
Object.values([true, false]).forEach(function (isRead) {
  test('ChartBulletComparativeErrorMeasure', function () {
    var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletComparativeErrorMeasure.ChartBulletComparativeErrorMeasure, null));
    expect(view).toMatchSnapshot();
  });
});
test('renders component data', function () {
  var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletComparativeErrorMeasure.ChartBulletComparativeErrorMeasure, {
    data: [{
      y: 88
    }],
    domain: {
