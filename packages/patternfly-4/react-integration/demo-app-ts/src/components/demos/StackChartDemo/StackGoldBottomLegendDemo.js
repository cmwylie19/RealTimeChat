...
var StackGoldBottomLegendDemo = /** @class */ (function (_super) {
    __extends(StackGoldBottomLegendDemo, _super);
    function StackGoldBottomLegendDemo() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    StackGoldBottomLegendDemo.prototype.componentDidMount = function () {
        window.scrollTo(0, 0);
    };
    StackGoldBottomLegendDemo.prototype.render = function () {
        return (<div>
        <div style={{ height: '275px', width: '450px' }}>
          <react_charts_1.Chart domainPadding={{ x: [30, 25] }} legendData={[{ name: 'Cats' }, { name: 'Birds' }, { name: 'Dogs' }, { name: 'Mice' }]} legendPosition="bottom" height={275} padding={{
            ...
            right: 50,
            top: 50
        }} themeColor={react_charts_1.ChartThemeColor.gold} width={450}>
    ...
    return StackGoldBottomLegendDemo;
}(react_1["default"].Component));
exports.StackGoldBottomLegendDemo = StackGoldBottomLegendDemo;
