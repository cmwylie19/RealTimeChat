(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "./AboutModal", "./Accordion", "./Alert", "./ApplicationLauncher", "./Avatar", "./Backdrop", "./BackgroundImage", "./Badge", "./Brand", "./Breadcrumb", "./Button", "./Card", "./Checkbox", "./ChipGroup", "./ClipboardCopy", "./ContextSelector", "./DataList", "./Dropdown", "./EmptyState", "./Expandable", "./Form", "./FormSelect", "./InputGroup", "./Label", "./List", "./LoginPage", "./Modal", "./Nav", "./NotificationBadge", "./OptionsMenu", "./Page", "./Pagination", "./Popover", "./Progress", "./Radio", "./Select", "./SkipToContent", "./Switch", "./Tabs", "./Text", "./TextArea", "./TextInput", "./Title", "./Tooltip", "./Wizard", "./withOuia"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("./AboutModal"), require("./Accordion"), require("./Alert"), require("./ApplicationLauncher"), require("./Avatar"), require("./Backdrop"), require("./BackgroundImage"), require("./Badge"), require("./Brand"), require("./Breadcrumb"), require("./Button"), require("./Card"), require("./Checkbox"), require("./ChipGroup"), require("./ClipboardCopy"), require("./ContextSelector"), require("./DataList"), require("./Dropdown"), require("./EmptyState"), require("./Expandable"), require("./Form"), require("./FormSelect"), require("./InputGroup"), require("./Label"), require("./List"), require("./LoginPage"), require("./Modal"), require("./Nav"), require("./NotificationBadge"), require("./OptionsMenu"), require("./Page"), require("./Pagination"), require("./Popover"), require("./Progress"), require("./Radio"), require("./Select"), require("./SkipToContent"), require("./Switch"), require("./Tabs"), require("./Text"), require("./TextArea"), require("./TextInput"), require("./Title"), require("./Tooltip"), require("./Wizard"), require("./withOuia"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.AboutModal, global.Accordion, global.Alert, global.ApplicationLauncher, global.Avatar, global.Backdrop, global.BackgroundImage, global.Badge, global.Brand, global.Breadcrumb, global.Button, global.Card, global.Checkbox, global.ChipGroup, global.ClipboardCopy, global.ContextSelector, global.DataList, global.Dropdown, global.EmptyState, global.Expandable, global.Form, global.FormSelect, global.InputGroup, global.Label, global.List, global.LoginPage, global.Modal, global.Nav, global.NotificationBadge, global.OptionsMenu, global.Page, global.Pagination, global.Popover, global.Progress, global.Radio, global.Select, global.SkipToContent, global.Switch, global.Tabs, global.Text, global.TextArea, global.TextInput, global.Title, global.Tooltip, global.Wizard, global.withOuia);
    global.undefined = mod.exports;
  }
})(this, function (exports, _AboutModal, _Accordion, _Alert, _ApplicationLauncher, _Avatar, _Backdrop, _BackgroundImage, _Badge, _Brand, _Breadcrumb, _Button, _Card, _Checkbox, _ChipGroup, _ClipboardCopy, _ContextSelector, _DataList, _Dropdown, _EmptyState, _Expandable, _Form, _FormSelect, _InputGroup, _Label, _List, _LoginPage, _Modal, _Nav, _NotificationBadge, _OptionsMenu, _Page, _Pagination, _Popover, _Progress, _Radio, _Select, _SkipToContent, _Switch, _Tabs, _Text, _TextArea, _TextInput, _Title, _Tooltip, _Wizard, _withOuia) {
  "use strict";
