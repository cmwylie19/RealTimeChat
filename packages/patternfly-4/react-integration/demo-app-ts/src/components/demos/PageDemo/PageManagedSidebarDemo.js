...
var PageManagedSidebarDemo = /** @class */ (function (_super) {
    __extends(PageManagedSidebarDemo, _super);
    function PageManagedSidebarDemo() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PageManagedSidebarDemo.prototype.componentDidMount = function () {
        window.scrollTo(0, 0);
    };
    PageManagedSidebarDemo.prototype.render = function () {
        var logoProps = {
        ...
        return (<react_core_1.Page id="page-managed-sidebar-demo" header={Header} sidebar={Sidebar} isManagedSidebar>
    ...
    return PageManagedSidebarDemo;
}(react_1["default"].Component));
exports.PageManagedSidebarDemo = PageManagedSidebarDemo;
