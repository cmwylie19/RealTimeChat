...
export const DataToolbarItem = (_ref) => {
  ...
  return React.createElement("div", _extends({
    className: css(styles.dataToolbarItem, variant && getModifier(styles, variant), formatBreakpointMods(breakpointMods, styles), formatSpacers(spacers), className)
  }, labelVariant && {
    'aria-hidden': true
  }, {
    id: id
...
DataToolbarItem.propTypes = {
  ...
  variant: _pt.oneOfType([_pt.any, _pt.oneOf(['separator']), _pt.oneOf(['bulk-select']), _pt.oneOf(['overflow-menu']), _pt.oneOf(['pagination']), _pt.oneOf(['search-filter']), _pt.oneOf(['label'])]),
