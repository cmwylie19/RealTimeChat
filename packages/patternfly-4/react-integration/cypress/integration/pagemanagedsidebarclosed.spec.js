describe('Page Managed Sidebar Closed Demo Test', function () {
    it('Navigate to page section', function () {
    ...
    it('Test Page elements', function () {
        cy.get('#nav-toggle').then(function (hamburgerIcon) {
            cy.get('#page-managed-sidebar-closed-demo').within(function () {
