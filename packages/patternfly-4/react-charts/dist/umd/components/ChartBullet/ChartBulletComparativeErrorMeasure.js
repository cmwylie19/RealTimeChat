(function (global, factory) {
  ...
  exports.ChartBulletComparativeErrorMeasure = undefined;
   ...
   */
  const ChartBulletComparativeErrorMeasure = exports.ChartBulletComparativeErrorMeasure = _ref => {
    let {
      ariaDesc,
      ariaTitle,
      barWidth,
  ...
  (0, _hoistNonReactStatics2.default)(ChartBulletComparativeErrorMeasure, _victory.VictoryBar);
});
