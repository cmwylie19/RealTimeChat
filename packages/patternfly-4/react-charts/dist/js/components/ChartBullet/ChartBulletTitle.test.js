...
Object.values([true, false]).forEach(function (isRead) {
  test('ChartBulletTitle', function () {
    var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletTitle.ChartBulletTitle, null));
    expect(view).toMatchSnapshot();
  });
});
test('renders component data', function () {
  var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletTitle.ChartBulletTitle, {
    title: "Text label",
