...
test('AboutModalBoxCloseButton Test', function () {
  var view = (0, _enzyme.shallow)(React.createElement(_AboutModalBoxCloseButton.AboutModalBoxCloseButton, null));
  expect(view).toMatchSnapshot();
});
test('AboutModalBoxCloseButton Test onclose', function () {
  var onClose = jest.fn();
  var view = (0, _enzyme.shallow)(React.createElement(_AboutModalBoxCloseButton.AboutModalBoxCloseButton, {
    onClose: onClose
  }));
  expect(view).toMatchSnapshot();
});
