(function (global, factory) {
  ...
  const DataToolbarContent = exports.DataToolbarContent = _ref => {
    let {
      className,
      children,
      breakpointMods = []
    } = _ref,
        props = _objectWithoutProperties(_ref, ["className", "children", "breakpointMods"]);
