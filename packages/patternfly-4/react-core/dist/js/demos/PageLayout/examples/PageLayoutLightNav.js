...
var PageLayoutLightNav =
/*#__PURE__*/
function (_React$Component) {
  _inherits(PageLayoutLightNav, _React$Component);

  function PageLayoutLightNav(props) {
    var _this;

    _classCallCheck(this, PageLayoutLightNav);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(PageLayoutLightNav).call(this, props));
  ...
  _createClass(PageLayoutLightNav, [{
    key: "render",
    value: function render() {
      ...
      var pageId = 'main-content-page-layout-simple-nav';
  ...
  return PageLayoutLightNav;
}(_react["default"].Component);

var _default = PageLayoutLightNav;
exports["default"] = _default;
//# sourceMappingURL=PageLayoutLightNav.js.map