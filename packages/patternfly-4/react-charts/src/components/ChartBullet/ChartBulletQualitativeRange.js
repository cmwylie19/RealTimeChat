...
exports.ChartBulletQualitativeRange = function (_a) {
    var ariaDesc = _a.ariaDesc, ariaTitle = _a.ariaTitle, _b = _a.barWidth, barWidth = _b === void 0 ? ChartTheme_1.ChartBulletStyles.qualitativeRangeWidth : _b, _c = _a.constrainToVisibleArea, constrainToVisibleArea = _c === void 0 ? false : _c, data = _a.data, domain = _a.domain, _d = _a.horizontal, horizontal = _d === void 0 ? true : _d, _e = _a.invert, invert = _e === void 0 ? false : _e, labels = _a.labels, _f = _a.measureComponent, measureComponent = _f === void 0 ? <ChartBar_1.ChartBar /> : _f, padding = _a.padding, _g = _a.standalone, standalone = _g === void 0 ? true : _g, themeColor = _a.themeColor, themeVariant = _a.themeVariant, y = _a.y, y0 = _a.y0, 
    // destructure last
    _h = _a.theme, 
    // destructure last
    theme = _h === void 0 ? ChartUtils_1.getBulletQualitativeRangeTheme(themeColor, themeVariant) : _h, _j = _a.height, height = _j === void 0 ? theme.group.height : _j, _k = _a.width, width = _k === void 0 ? theme.group.width : _k, _l = _a.labelComponent, labelComponent = _l === void 0 ? <ChartTooltip_1.ChartTooltip /> : _l, rest = __rest(_a, ["ariaDesc", "ariaTitle", "barWidth", "constrainToVisibleArea", "data", "domain", "horizontal", "invert", "labels", "measureComponent", "padding", "standalone", "themeColor", "themeVariant", "y", "y0", "theme", "height", "width", "labelComponent"]);
    var computedData = utils_1.getQualitativeRangeData({
        data: data,
        invert: invert,
        theme: theme,
        y: y,
    ...
    var measure = computedData.map(function (dataPoint, index) {
        return React.cloneElement(measureComponent, __assign({ barWidth: barWidth, data: [__assign({}, dataPoint)], domain: domain,
            height: height,
            horizontal: horizontal, key: "pf-chart-bullet-qualitative-range-" + index, labelComponent: tooltip, labels: labels,
...
hoist_non_react_statics_1["default"](exports.ChartBulletQualitativeRange, victory_1.VictoryBar);
