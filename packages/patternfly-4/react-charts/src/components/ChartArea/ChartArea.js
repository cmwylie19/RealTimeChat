...
exports.ChartArea = function (_a) {
    ...
    return <victory_1.VictoryArea containerComponent={container} theme={theme} {...rest}/>;
};
// Note: VictoryArea.role must be hoisted
hoist_non_react_statics_1["default"](exports.ChartArea, victory_1.VictoryArea);
