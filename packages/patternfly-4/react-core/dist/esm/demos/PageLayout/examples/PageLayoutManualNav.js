...
import { Avatar, Brand, Button, ButtonVariant, Card, CardBody, Dropdown, DropdownToggle, DropdownItem, DropdownSeparator, Gallery, GalleryItem, KebabToggle, Nav, NavItem, NavList, Page, PageHeader, PageSection, PageSectionVariants, PageSidebar, SkipToContent, TextContent, Text, Toolbar, ToolbarGroup, ToolbarItem } from '@patternfly/react-core'; // make sure you've installed @patternfly/patternfly
...
class PageLayoutManualNav extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "onPageResize", ({
      mobileView,
      windowSize
    }) => {
      this.setState({
...
//# sourceMappingURL=PageLayoutManualNav.js.map