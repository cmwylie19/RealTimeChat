...
var DonutUtilizationStaticRightDemo = /** @class */ (function (_super) {
    __extends(DonutUtilizationStaticRightDemo, _super);
    function DonutUtilizationStaticRightDemo(props) {
    ...
    DonutUtilizationStaticRightDemo.prototype.componentDidMount = function () {
        var _this = this;
        window.scrollTo(0, 0);
    ...
    DonutUtilizationStaticRightDemo.prototype.componentWillUnmount = function () {
        clearInterval(this.interval);
    };
    DonutUtilizationStaticRightDemo.prototype.render = function () {
    ...
    return DonutUtilizationStaticRightDemo;
}(react_1["default"].Component));
exports.DonutUtilizationStaticRightDemo = DonutUtilizationStaticRightDemo;
