...
exports.TextListItem = function (_a) {
    var _b = _a.children, children = _b === void 0 ? null : _b, _c = _a.className, className = _c === void 0 ? '' : _c, _d = _a.component, component = _d === void 0 ? TextListItemVariants.li : _d, props = __rest(_a, ["children", "className", "component"]);
