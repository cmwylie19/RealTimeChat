...
Object.values([{
  ...
  test(`Drawer isExpanded = ${isExpanded} and isInline = ${isInline}`, () => {
    const view = mount(React.createElement(Drawer, {
      isExpanded: isExpanded,
      isInline: isInline
    }, React.createElement(DrawerContent, null, drawerContent), React.createElement(DrawerPanelContent, null, " drawer-panel ")));
