(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "react", "prop-types", "emotion-theming", "@patternfly/react-tokens"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("react"), require("prop-types"), require("emotion-theming"), require("@patternfly/react-tokens"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.emotionTheming, global.reactTokens);
    global.undefined = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _emotionTheming, _reactTokens) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.StyledTheme = exports.StyledConstants = undefined;
   ...
   */
  const StyledConstants = exports.StyledConstants = {
    space: {
      xs: 0,
      sm: 1,
      md: 2,
      ...
      neg_gutter: _reactTokens.global_gutter && `-${_reactTokens.global_gutter.var}`
    },
    fonts: {
  ...
  const StyledTheme = exports.StyledTheme = {
    ...
    borders: {
      sm: _reactTokens.global_BorderWidth_sm && `${_reactTokens.global_BorderWidth_sm.var} solid`,
      md: _reactTokens.global_BorderWidth_md && `${_reactTokens.global_BorderWidth_md.var} solid`,
      lg: _reactTokens.global_BorderWidth_lg && `${_reactTokens.global_BorderWidth_lg.var} solid`
    },
  ...
  exports.default = PatternFlyThemeProvider;
});
