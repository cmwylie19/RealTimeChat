...
function (_React$Component) {
  ...
  function DataToolbarToggleGroup() {
    ...
    _defineProperty(_assertThisInitialized(_this), "isContentPopup", function () {
      ...
      var lgBreakpointValue = parseInt(_reactTokens.global_breakpoint_lg.value);
    ...
    value: function render() {
      ...
      return React.createElement(_DataToolbarUtils.DataToolbarContext.Consumer, null, function (_ref) {
        var isExpanded = _ref.isExpanded,
            ...
            expandableContentId = _ref.expandableContentId;
        return React.createElement("div", _extends({
          className: (0, _reactStyles.css)(_dataToolbar["default"].dataToolbarGroup, variant && (0, _reactStyles.getModifier)(_dataToolbar["default"], variant), (0, _util.formatBreakpointMods)(breakpointMods, _dataToolbar["default"]), (0, _DataToolbarUtils.formatSpacers)(spacers, 'pf-m-space-items'), (0, _reactStyles.getModifier)(_dataToolbar["default"], 'toggle-group'), (0, _reactStyles.getModifier)(_dataToolbar["default"], "reveal-on-".concat(breakpoint)), className)
...
_defineProperty(DataToolbarToggleGroup, "propTypes", {
  ...
  breakpoint: _propTypes["default"].oneOf(['md', 'lg', 'xl', '2xl']).isRequired
});
