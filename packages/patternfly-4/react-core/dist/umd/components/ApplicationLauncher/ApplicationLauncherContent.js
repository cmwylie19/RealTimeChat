(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "@patternfly/react-styles", "@patternfly/react-styles/css/components/AppLauncher/app-launcher", "@patternfly/react-styles/css/utilities/Accessibility/accessibility", "./ApplicationLauncherIcon", "./ApplicationLauncherText", "@patternfly/react-icons", "./ApplicationLauncherItem"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("@patternfly/react-styles"), require("@patternfly/react-styles/css/components/AppLauncher/app-launcher"), require("@patternfly/react-styles/css/utilities/Accessibility/accessibility"), require("./ApplicationLauncherIcon"), require("./ApplicationLauncherText"), require("@patternfly/react-icons"), require("./ApplicationLauncherItem"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.reactStyles, global.appLauncher, global.accessibility, global.ApplicationLauncherIcon, global.ApplicationLauncherText, global.reactIcons, global.ApplicationLauncherItem);
    global.undefined = mod.exports;
  }
})(this, function (exports, _propTypes, _react, _reactStyles, _appLauncher, _accessibility, _ApplicationLauncherIcon, _ApplicationLauncherText, _reactIcons, _ApplicationLauncherItem) {
  "use strict";
  ...
  const ApplicationLauncherContent = exports.ApplicationLauncherContent = ({
    children
  }) => React.createElement(_ApplicationLauncherItem.ApplicationLauncherItemContext.Consumer, null, ({
    isExternal,
    icon
