...
Object.values([true, false]).forEach(function (isRead) {
  test('ChartBulletQualitativeRange', function () {
    var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletQualitativeRange.ChartBulletQualitativeRange, null));
    expect(view).toMatchSnapshot();
  });
});
test('renders component data', function () {
  var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletQualitativeRange.ChartBulletQualitativeRange, {
    data: [{
      y: 50
    }, {
      y: 85
