(function (global, factory) {
  ...
  exports.ChartBulletQualitativeRange = undefined;
   ...
   */
  const ChartBulletQualitativeRange = exports.ChartBulletQualitativeRange = _ref => {
    let {
      ariaDesc,
      ariaTitle,
      barWidth = _ChartTheme.ChartBulletStyles.qualitativeRangeWidth,
    ...
    const computedData = (0, _utils.getQualitativeRangeData)({
      data,
      invert,
      theme,
      y,
  ...
  (0, _hoistNonReactStatics2.default)(ChartBulletQualitativeRange, _victory.VictoryBar);
});
