...
exports.ChartBulletComparativeWarningMeasure = function (_a) {
    ...
    _f = _a.theme, 
    // destructure last
    theme = _f === void 0 ? ChartUtils_1.getBulletComparativeWarningMeasureTheme(themeColor, themeVariant) : _f, _g = _a.height, height = _g === void 0 ? theme.bar.height : _g, _h = _a.width, width = _h === void 0 ? theme.bar.width : _h, rest = __rest(_a, ["ariaDesc", "ariaTitle", "barWidth", "constrainToVisibleArea", "data", "domain", "horizontal", "labelComponent", "labels", "measureComponent", "padding", "standalone", "themeColor", "themeVariant", "y", "theme", "height", "width"]);
...
hoist_non_react_statics_1["default"](exports.ChartBulletComparativeWarningMeasure, victory_1.VictoryBar);
