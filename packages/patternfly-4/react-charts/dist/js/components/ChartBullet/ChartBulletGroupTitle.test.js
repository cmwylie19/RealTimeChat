...
Object.values([true, false]).forEach(function (isRead) {
  test('ChartBulletGroupTitle', function () {
    var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletGroupTitle.ChartBulletGroupTitle, null));
    expect(view).toMatchSnapshot();
  });
});
test('renders component data', function () {
  var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletGroupTitle.ChartBulletGroupTitle, {
    title: "Text label",
