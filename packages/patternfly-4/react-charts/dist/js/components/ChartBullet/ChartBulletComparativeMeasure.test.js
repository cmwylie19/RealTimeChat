...
Object.values([true, false]).forEach(function (isRead) {
  test('ChartBulletComparativeMeasure', function () {
    var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletComparativeMeasure.ChartBulletComparativeMeasure, null));
    expect(view).toMatchSnapshot();
  });
});
test('renders component data', function () {
  var view = (0, _enzyme.shallow)(React.createElement(_ChartBulletComparativeMeasure.ChartBulletComparativeMeasure, {
    data: [{
      y: 100
    }],
    domain: {
