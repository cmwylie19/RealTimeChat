...
exports.ChartScatter = function (_a) {
    ...
    return <victory_1.VictoryScatter containerComponent={container} theme={theme} {...rest}/>;
};
// Note: VictoryLine.role must be hoisted
hoist_non_react_statics_1["default"](exports.ChartScatter, victory_1.VictoryScatter);
