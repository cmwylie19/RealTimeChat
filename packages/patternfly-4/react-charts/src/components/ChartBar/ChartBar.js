...
exports.ChartBar = function (_a) {
    ...
    return <victory_1.VictoryBar containerComponent={container} theme={theme} {...rest}/>;
};
// Note: VictoryBar.getDomain & VictoryBar.role must be hoisted
hoist_non_react_statics_1["default"](exports.ChartBar, victory_1.VictoryBar);
